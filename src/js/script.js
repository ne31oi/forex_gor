...
(function(f, r, h, t, v) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(a) {
        ...
        var c = d.call(arguments, 1),
            e = function() {
                if (this instanceof e) { var g = function() {};
    ...
    Array.prototype.indexOf || (Array.prototype.indexOf = function(a, b) { var d; if (null == this) throw new TypeError('"this" is null or not defined'); var c = Object(this),
            e = c.length >>> 0; if (0 === e) return -1;
        d = +b || 0;
        Infinity === Math.abs(d) && (d = 0); if (d >= e) return -1; for (d = Math.max(0 <= d ? d : e - Math.abs(d), 0); d < e;) { if (d in c && c[d] === a) return d;
            d++ } return -1 });
    ...
    q.prototype = {
        ...
        validate: function() {
            ...
            else { if (a.from < a.min || a.from > a.max) a.from = a.min; if (a.to > a.max || a.to < a.min) a.to = a.max;
        ...
        calcGridCollision: function(a, b, d) { var c, e, g, f = this.coords.big_num; for (c = 0; c < f; c += a) { e = c + a / 2; if (e >= f) break;
    ...
    (function() {
        ...
        h.requestAnimationFrame || (h.requestAnimationFrame = function(b, d) { var g = (new Date).getTime(),
                f = Math.max(0, 16 - (g - a)),
...
$(document).ready(function() {
    ...
    function rangeHourFunc(data) {
        ...
        var hourTxt = declension(data, ['час', 'часа', 'часов']);
    ...
    function rangeDaysFunc(data) {
        ...
        var daysTxt = declension(data, ['день', 'дня', 'дней']);
    ...
    $('.faq_button').on('click', function() {
        ...
        if (buttonTxt.html() === 'Скрыть') {
            buttonTxt.html('Смотреть еще');
        } else {
            buttonTxt.html('Скрыть');
        }
    });
